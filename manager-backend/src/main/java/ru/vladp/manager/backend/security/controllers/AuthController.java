package ru.vladp.manager.backend.security.controllers;
...
import ru.vladp.manager.backend.emailgreeting.services.EmailSenderService;
import ru.vladp.manager.backend.security.model.User;
import ru.vladp.manager.backend.security.services.RegistrationService;
